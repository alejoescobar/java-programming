...
public class CSVMin {
    ...
    public String getColdestOfTwoFileName(CSVRecord current, CSVRecord coldestSoFar, String currentFileName, String coldestFileName) {
       String tempSize = (current.get("TemperatureF"));
       System.out.println(coldestSoFar);
       if (coldestSoFar == null && tempSize != "-9999") {
          coldestFileName = currentFileName;
          coldestSoFar = current;
       } else {
           double currentTemp = Double.parseDouble(current.get("TemperatureF"));
           double coldestTemp = Double.parseDouble(coldestSoFar.get("TemperatureF"));
    ...
    public CSVRecord getLowestHumidityOfTwo(CSVRecord current, CSVRecord lowestHumiditySoFar) {
       ...
       if (lowestHumiditySoFar == null && tempSize != "N/A") {
